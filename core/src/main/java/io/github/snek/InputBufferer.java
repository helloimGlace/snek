...
public class InputBufferer implements InputProcessor {
    private HashMap<Integer, Direction> directionMap = new HashMap<Integer, Direction>() {{
        put(19, Direction.UP);
        put(20, Direction.DOWN);
        put(21, Direction.LEFT);
        put(22, Direction.RIGHT);
    }};
    private HashMap<Direction, Direction> blacklisted = new HashMap<Direction, Direction>() {{
